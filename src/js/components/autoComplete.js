...
export default class AutoComplete extends React.Component {
	render() {
		...
		const renderItems = suggestedValues.map((suggestedValue) => {return <a class="list-group-item list-group-item-action" onClick={() => { this.props.onclick(suggestedValue.id, suggestedValue.title, suggestedValue.code) } }>{suggestedValue.title}</a> });
